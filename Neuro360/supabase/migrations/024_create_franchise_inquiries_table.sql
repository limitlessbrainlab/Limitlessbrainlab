...
DROP POLICY IF EXISTS "Allow public insert on franchise_inquiries" ON franchise_inquiries;
...
DROP POLICY IF EXISTS "Allow super admin read on franchise_inquiries" ON franchise_inquiries;
...
DROP POLICY IF EXISTS "Allow super admin update on franchise_inquiries" ON franchise_inquiries;
